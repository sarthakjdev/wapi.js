...
export const TemplateMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
          ...
          .array(
            z
              .object({
                ...
                parameters: z
                  .array(TemplateMessageParameterSchemaType)
                  .optional(),
              })
              .or(
                z.object({
...
export const TextMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
...
export const AudioMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
...
export const VideoMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
...
export const DocumentMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
      type: z.literal(MessageTypeEnum.Document),
      document: ExternalDocumentMediaObjectSchemaType.or(
        MetaDocumentMediaObjectSchemaType,
      ),
    }),
  );
...
export const ImageMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
...
export const ContactMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
...
export const LocationMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
...
export const StickerMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
      type: z.literal(MessageTypeEnum.Sticker),
      sticker: ExternalStickerMediaObjectType.or(
        MetaStickerMediaObjectSchemaType,
      ),
    }),
  );
...
export const ReactionMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
...
export const ButtonInteractiveMessagePayload =
  BaseInteractiveMessagePayload.merge(
    z.object({
...
export const ProductListInteractiveMessagePayload =
  BaseInteractiveMessagePayload.merge(
    z.object({
...
export const ProductInteractiveMessagePayload =
  BaseInteractiveMessagePayload.merge(
    z.object({
...
export const CatalogInteractiveMessagePayload =
  BaseInteractiveMessagePayload.merge(
    z.object({
...
export const ListInteractiveMessagePayload =
  BaseInteractiveMessagePayload.merge(
    z.object({
...
export const InteractiveMessageApiPayloadSchemaType =
  BaseMessageApiPayloadSchema.merge(
    z.object({
      type: z.literal(MessageTypeEnum.Interactive),
      interactive: ButtonInteractiveMessagePayload.or(
        FlowInteractiveMessagePayload,
      )
...
export const WhatsappCloudApiRequestPayloadSchemaType =
  ImageMessageApiPayloadSchemaType.or(TextMessageApiPayloadSchemaType)
