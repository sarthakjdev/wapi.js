import { type BaseMessage } from './doc/message/IBaseMessage'
import { type MessageTypeEnum } from './doc/IMessageType'
...
export class MessageComponent {
	 ...
	 *  @memberof Component
	 */
	protected type: MessageTypeEnum
	 ...
	 * @returns {this}
	 */
	public setType(type: MessageTypeEnum): this {
		this.type = type
